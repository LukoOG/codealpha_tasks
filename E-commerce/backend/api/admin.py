...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('first_name', 'last_name', 'phone_number', 'shipping_address')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'first_name', 'last_name', 'phone_number', 'shipping_address', 'password1', 'password2'),
        }),
    )
